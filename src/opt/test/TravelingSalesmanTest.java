...
public class TravelingSalesmanTest {
    ...
    public static void main(String[] args) {
        ...
        FixedIterationTrainer fit = new FixedIterationTrainer(rhc, 100000);      //20000
        ...
        fit = new FixedIterationTrainer(sa, 100000);      //20000
        ...
        fit = new FixedIterationTrainer(ga, 100000);
        ...
        for (int i = 0; i < rhcList.size(); i++) {
            ...
            lines.add(i + ", " + rhcVal + saVal + gaVal + rhcTime + saTime + gaTime);
        }
