 ...
 * @version 1.0
 */
public class GAjackPop {
    private static Instance[] instances = initializeInstances();

    private static Integer[] pop = new Integer[]{50, 100, 200,400};//, 16, 20
    ...
    private static FeedForwardNetwork networks[] = new FeedForwardNetwork[pop.length];
    //private static NeuralNetworkOptimizationProblem[] nnop = new NeuralNetworkOptimizationProblem[100];
    private static NeuralNetworkOptimizationProblem[] nnop = new NeuralNetworkOptimizationProblem[pop.length];

    //private static OptimizationAlgorithm[] oa = new OptimizationAlgorithm[100];
    private static OptimizationAlgorithm[] oa = new OptimizationAlgorithm[pop.length];
    //private static String[] oaNames = new String[100];
    //private static String[] oaNames = new String[3];
    private static String[] oaNames = {"50", "100", "200", "400"};//, "16", "20"
    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < pop.length; k++) {
            ...
            oa[k] = new StandardGeneticAlgorithm(pop[k], pop[k]/2, pop[k]/4, nnop[k]);
