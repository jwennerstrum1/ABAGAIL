 ...
 * @version 1.0
 */
public class GAjackMate {
    private static Instance[] instances = initializeInstances();

    private static Integer[] mate = new Integer[]{25, 50, 75, 100};
    ...
    private static FeedForwardNetwork networks[] = new FeedForwardNetwork[mate.length];
    //private static NeuralNetworkOptimizationProblem[] nnop = new NeuralNetworkOptimizationProblem[100];
    private static NeuralNetworkOptimizationProblem[] nnop = new NeuralNetworkOptimizationProblem[mate.length];

    //private static OptimizationAlgorithm[] oa = new OptimizationAlgorithm[100];
    private static OptimizationAlgorithm[] oa = new OptimizationAlgorithm[mate.length];
    //private static String[] oaNames = new String[100];
    //private static String[] oaNames = new String[3];
    private static String[] oaNames = {"25", "50", "75", "100"};
    ...
    public static void main(String[] args) {
        ...
        for (int k = 0; k < mate.length; k++) {
            ...
            oa[k] = new StandardGeneticAlgorithm(100, mate[k], 0, nnop[k]);
