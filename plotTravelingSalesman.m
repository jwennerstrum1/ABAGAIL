...
Path = 'src/opt/test/';
FileName = 'TravelingSalesman.csv';
...
title('Fitness value vs. Iterations (100,000)', 'Interpreter', 'latex', 'FontSize', 14);

figure(2)
xlabel('Iterations',  'Interpreter', 'latex', 'FontSize', 14);
ylabel('Time',  'Interpreter', 'latex', 'FontSize', 14);
legend(Algorithms, 'FontSize', 14, 'Interpreter', 'latex');
title('Time vs. Iterations (100,000)', 'Interpreter', 'latex', 'FontSize', 14);
